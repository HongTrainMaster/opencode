export const dict = {
  ...
  "ui.promptInput.localKnowledge": "Pomiń lokalną bazę wiedzy",

  "ui.promptInput.localKnowledgeHint":

    "Włącz, aby odpowiadać wyłącznie modelem: umiejętność llm-wiki i lokalna baza wiedzy nie są wczytywane.",
