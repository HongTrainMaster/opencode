export const dict = {
  ...
  "ui.promptInput.localKnowledge": "Не искать в локальной базе знаний",

  "ui.promptInput.localKnowledgeHint":

    "Включите, чтобы отвечать только силами модели: навык llm-wiki и локальная база знаний не загружаются.",
